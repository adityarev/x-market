...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('/')}}">X-Market</a>
        </div>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                @foreach($category->subCategories as $subCategory)
                                    <li><a tabindex="-1" href="{{ url('categories/'.$category->category_name.'/'.$subCategory->sub_category_name) }}"> {{ $subCategory->sub_category_name }} </a></li>
                                @endforeach                                
                            </ul>
                        </li>
                        @endforeach                        
                                ...
                                <li id='{{$notification->id}}'>
                                    <div class="media">
                                        <div class="media-left">                                        
                                            <a href="{{$notification->notification_hyperlink}}">
